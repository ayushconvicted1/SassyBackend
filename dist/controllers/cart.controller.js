...
exports.getCart = exports.verifyCartItems = exports.addToCart = void 0;
    ...
    try {
        ...
        if (existingItem) {
            ...
            if (product.stock < newQuantity) {
                return res.status(400).json({
                    error: `Cannot add ${quantity} more items. Only ${product.stock - existingItem.quantity} additional items available`,
                });
            }
...
const verifyCartItems = async (req, res) => {
    try {
...
exports.verifyCartItems = verifyCartItems;
const getCart = async (req, res) => {
    try {
        ...
        const items = cart.items.map((item) => ({
            ...
            available: item.product.isAvailable && item.product.stock >= item.quantity,
